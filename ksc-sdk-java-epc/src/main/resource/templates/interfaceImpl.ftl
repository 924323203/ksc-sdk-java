...
public class KSCEPCClient extends KscWebServiceClient implements KSCEPC {
	...
	public ${impl.returnType} ${impl.action?uncap_first}(${impl.paramType} ${impl.paramType?uncap_first}) {
		...
		Request<${impl.paramType}> request = null;
		Response<${impl.returnType}> response = null;
		try {
			...
			HttpResponseHandler<KscWebServiceResponse<${impl.returnType}>> responseHandler = protocolFactory
					.createResponseHandler(
							new JsonOperationMetadata().withPayloadJson(true).withHasStreamingSuccessResponse(false),
							new ${impl.returnType}JsonUnmarshaller());
